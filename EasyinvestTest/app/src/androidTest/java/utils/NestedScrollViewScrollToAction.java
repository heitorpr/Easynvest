...
//GIST: https://gist.github.com/miszmaniac/12f720b7e898ece55d2464fe645e1f36

public final class NestedScrollViewScrollToAction implements ViewAction {
    private final String TAG = NestedScrollViewScrollToAction.class.getSimpleName();

    public NestedScrollViewScrollToAction scrollTo() {
    ...
    public void perform(UiController uiController, View view) {
        ...
        FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) parentScrollView.getLayoutParams();
